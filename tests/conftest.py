...
def movie_dao():
    ...
    movie_1 = Movie(id=1, title="Movie 1", description="Description", trailer="link", year=2000, rating=10.0, genre_id=1, director_id=1)
    movie_2 = Movie(id=2, title="Movie 2", description="Description", trailer="link", year=2000, rating=10.0, genre_id=1, director_id=1)
    movie_3 = Movie(id=3, title="Movie 3", description="Description", trailer="link", year=2000, rating=10.0, genre_id=1, director_id=1)
